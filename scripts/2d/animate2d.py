...
#caption_format = 't = {t:.1f}, E_field = {Efield:.6f}, energy = {energy:.6f}'
caption_format = 't = {t:.1f}'
...
with h5py.File(fname,'r') as h5file:
    ...
    try:
        ...
        Efield_vec = np.zeros_like(energy_vec)
    ...
    for i in tqdm(range(nmax)):
        ...
        interpr = RectBivariateSpline(x_range, y_range, psi.real)
        interpi = RectBivariateSpline(x_range, y_range, psi.imag)
