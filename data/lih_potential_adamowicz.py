...
class LiH_Potential:
    def __init__(self, withAdiabaticCorrection=True, zero_point='dissociation'):
        ...
        self.Rdata, self.Vdata = parse_Vdata("lih_potential_adamowicz.txt", withAdiabaticCorrection=withAdiabaticCorrection)
...
class LiH_Dipole:
    def __init__(self, unit='a.u.'):
        ...
        self.Rdata, self.Ddata = parse_Ddata("lih_dipole_adamowicz.txt")
...
if __name__ == '__main__':
    ...
    Re = V.get_Re()
    Ve = V(Re)
    print(f"Re= {Re} bohr     V(Re) = {Ve*1e3} mEh")
